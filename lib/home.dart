...
import 'package:lb_13_khonesavanh_vieng_xay_2cw3/database.dart';
import 'package:lb_13_khonesavanh_vieng_xay_2cw3/edit_entry.dart';
...
class _homeState extends State<home> {
  Database _database = Database(
      journal: [Journal(id: "id", date: "date", mood: "mood", note: "note")]);
  DatabaseFileRoutines databaseFileRoutines = DatabaseFileRoutines();
